    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute -top-2 -right-2 z-10 w-8 h-8 bg-danger hover:bg-danger/80 rounded-full flex items-center justify-center text-white transition-colors shadow-lg"
          >
