    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <div className="fixed inset-0 z-[99999] isolate">
          ...
          {/* Modal Container */}
          <div className="relative z-[100000] flex items-center justify-center min-h-screen p-4">
            <motion.div
            ...
            >
              ...
              <button
                onClick={onClose}
                className="absolute -top-3 -right-3 z-[100001] w-12 h-12 bg-gradient-to-br from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 rounded-full flex items-center justify-center text-white transition-all duration-200 shadow-2xl hover:scale-110 border-4 border-white/20"
