...
const features = [
  {
    ...
    gradient: "from-[#FF4655] to-[#FFD700]",
    glowColor: "rgba(255,70,85,0.15)",
    stat: "99.7%",
    statLabel: "Precisión"
  },
  {
    ...
    gradient: "from-[#C850C0] to-[#FFD700]",
    glowColor: "rgba(200,80,192,0.15)",
    stat: "360°",
    statLabel: "Cobertura"
  },
  {
    ...
    gradient: "from-[#FFD700] to-[#FF4655]",
  ...
  },
  {
    ...
    gradient: "from-[#FF4655] to-[#C850C0]",
    glowColor: "rgba(255,70,85,0.12)",
    stat: "ML",
    statLabel: "Powered"
  },
  {
    ...
    gradient: "from-[#C850C0] to-[#FF4655]",
    glowColor: "rgba(200,80,192,0.12)",
    stat: "0s",
    statLabel: "Downtime"
  },
  {
    ...
    gradient: "from-[#FFD700] to-[#C850C0]",
